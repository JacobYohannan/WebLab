...
<center>
            ...
            <form method="post">
                <label for="fname">Accession no</label><br>
                <input type="text" id="accession_no" name="accession_no"><br>



                <label for="lname">Book title</label><br>
                ...
                <label for="lname">Edition</label><br>
                <input type="text" id="edition" name="edition" required><br>


                <label for="lname">Publisher name</label><br>
